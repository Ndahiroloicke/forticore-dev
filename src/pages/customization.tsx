...
dependencies:
  - requests>=2.25.0
  - pyyaml>=5.4.0`}
            caption="Plugin configuration example"
          />
        </section>
...
class CustomScanner(Scanner):
    ...
    def __init__(self):
        super().__init__(
            name="Custom Scanner",
            description="Custom vulnerability scanning logic"
        )
    ...
    def scan(self, target, options=None):
        ...
        try:
            ...
            # Example: Check for specific vulnerability
        ...
        return vulnerabilities`}
            caption="Example custom scanner implementation"
          />
