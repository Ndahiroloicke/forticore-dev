        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
          <Card className="bg-white dark:bg-dark-300 border border-purple-100 dark:border-purple-900/30 h-full">
            ...
            <CardContent>
              ...
              <CodeBlock
                code="ftcore scan --type webapp --target https://example.com"
                caption="Web application scan"
              />
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-dark-300 border border-purple-100 dark:border-purple-900/30 h-full">
            ...
            <CardContent>
              ...
              <CodeBlock
                code="ftcore scan --type network --target 192.168.1.0/24"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-white dark:bg-dark-300 border border-purple-100 dark:border-purple-900/30 h-full">
            ...
            <CardContent>
              ...
              <CodeBlock
                code="ftcore scan --type ssl --target example.com"
                caption="SSL/TLS analysis"
              />
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-dark-300 border border-purple-100 dark:border-purple-900/30 h-full">
            ...
            <CardContent>
              ...
              <CodeBlock
                code="ftcore scan --type ports --target 192.168.1.10"
                caption="Port scan"
              />
            </CardContent>
          </Card>
        ...
        <div className="space-y-4 mb-6">
          <Card className="bg-white dark:bg-dark-300 border border-purple-100 dark:border-purple-900/30">
            ...
            <CardContent>
              ...
              <CodeBlock
                code="ftcore scan --target example.com --intensity high"
                caption="High intensity scan"
              />
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-dark-300 border border-purple-100 dark:border-purple-900/30">
            ...
            <CardContent>
              ...
              <CodeBlock
                code="ftcore scan --target example.com --ports 1-1000"
                caption="Custom port range"
              />
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-dark-300 border border-purple-100 dark:border-purple-900/30">
            ...
            <CardContent>
              ...
              <CodeBlock
                code="ftcore scan --target example.com --output json"
                caption="JSON output format"
              />
            </CardContent>
          </Card>
        </div>
